...
<!--        <script src="ckeditor/ckeditor.js"></script>-->
    ...
    <body>
                        ...
                        <li class="green">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                ...
                                <span class="badge badge-success">                                    
                                    <?php
                                    if(isset(Utils::getSession("user")->display_name)){
                                        $message = Message::model()->findAll(array("condition" => "`to_userName`="."\"".Utils::getSession("user")->display_name."\""." AND `reveicer_deleted`=0"));
                                        if (count($message) > 0) {
                                    ...
                                    <a href="#"> 
                                        <span class="msg-body">
                                            <span class="msg-title">
                                                <span class="blue"><?php echo $row->display_name; ?>:</span>
                                                <?php echo substr(Utils::removeHtmlString($row->content),0,50); ?>
                                            </span>

                                            <span class="msg-time">
                                                <i class="icon-time"></i>
                                                <span><?php echo Utils::DateConvert($row->pub_time); ?></span>
                                            </span>
                                        </span>
                                    </a>
                                </li>
                        ...
                        <li class="light-blue">
                            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                ...
                                <span class="user-info">
                                    ...
                                    <?php
                                    if (Utils::getSession("user") != "") {
                                        echo Utils::getSession("user")->display_name;
                                    }
                                    ?>
                                </span>
                            ...
                            <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                                ...
                                <li><a href="<?php echo $this->createUrl("profile/index"); ?>"><i class="icon-user"></i>Profile</a></li>
                                <li class="divider"></li>
                                <li><a href="<?php echo $this->createUrl("user/logout"); ?>"><i class="icon-off"></i>Logout</a></li>
                            </ul>
                        </li>
                    </ul><!-- /.ace-nav -->
                </div><!-- /.navbar-header -->
                ...
                <div class="sidebar" id="sidebar">
                    ...
                    <ul class="nav nav-list">
                        ...
                        <li <?php if ($this->menuActive == "NewsController") echo "class='active open'"; ?>>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="<?php echo $this->createUrl('adminNews/listNews'); ?>">
                                ...
                                <li>
                                    <a href="<?php echo $this->createUrl('adminNews/create'); ?>">
                                        <i class="icon-double-angle-right"></i>
                                        Create News
                                    </a>
                                </li>
                        ...
                        <li <?php if ($this->menuActive == "CategoryController") echo "class='active open'"; ?>>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="<?php echo $this->createUrl('category/listCat'); ?>">
                                        <i class="icon-double-angle-right"></i>List Category
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo $this->createUrl('category/createCat'); ?>">
                                        <i class="icon-double-angle-right"></i>Create Category
                                    </a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="<?php echo $this->createUrl('user/list'); ?>">
                                        <i class="icon-double-angle-right"></i>List Users
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo $this->createUrl('user/create'); ?>">
                                        <i class="icon-double-angle-right"></i>Create User
                                    </a>
                                </li>
                            </ul>
                        </li>
        ...
        <!--<script src="js/ckeditor/ckeditor_full.js"></script>-->
        <script src="js/ckeditor_standa/ckeditor.js"></script>
