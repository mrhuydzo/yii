...
?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            <?php
                $listUserName = CHtml::listData(user::model()->findAll(array('order' => 'display_name')), 'user_id', 'display_name'); //table_col_name1 is value of option, table_col_name2 is label of option
                //var_dump($list);die;
